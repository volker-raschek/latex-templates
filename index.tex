...
\setlength{\footnotemargin}{0.3em} % Fußnotenzahl einrücken
...
\hypersetup{
  ...
  pdfsubject={Konzeptionierung und Realisierung einer horizontal skalierbaren Clusterarchitektur},
  pdfkeywords={B.Sc. Markus Pesch, Prof. Dr. Helge Rieder, FH Trier, Fachbereich Wirtschaft},
  pdfcreator={latexmk},
...
\usepackage[acronyms, nomain, style=tree, toc, xindy]{glossaries}
